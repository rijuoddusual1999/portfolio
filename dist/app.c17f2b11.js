...
// Select DOM elements
var bar = document.querySelector(".loader_bar--inner");
var countnum = document.querySelector(".loader_counter--number-counter");
var count = document.querySelector(".loader");
var c = 0;
...
var barinterval = setInterval(function () {
  ...
  if (c === 100) {
    ...
    _gsap.default.to(".loader_bar, .loader_counter", {
      duration: 5,
      rotate: "90deg",
      left: "1000%"
    });
    _gsap.default.to(".loader_text", {
      duration: 2,
      opacity: 0
    });
...
var bg = document.getElementById('svg_box');
var count_svg = 20;
...
setInterval(function () {
  ...
  for (var _i = 0; _i < glitch.length(); _i++) {
    ...
    glitch[_i].style.width = Math.floor(Math.random() * 400) + 'px';
    glitch[_i].style.height = Math.floor(Math.random() * 100) + 'px';
    glitch[_i].style.backgound_position = Math.floor(Math.random() * 50) + 'px';
  }
}, 200);
...
//# sourceMappingURL=/app.c17f2b11.js.map